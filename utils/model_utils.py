...
def get_model_from_yaml(yaml_args):
    ...
    if model_name == 'AB_MIL':
        ...
        return mil_model
    elif model_name == 'SAT_MIL':
        mil_model = SAT_MIL(num_classes=yaml_args.General.num_classes,embed_dim=yaml_args.Model.in_dim,num_heads=yaml_args.Model.num_heads)
        return mil_model
